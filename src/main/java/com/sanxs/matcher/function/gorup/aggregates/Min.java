 ...
 **/
@NoArgsConstructor
public class Min<Data, GroupData extends Data> extends AbstractGroupByAggregateHandler<Data, GroupData, Long, Long> {

    private Long max = null;

    public Min(GetFieldFunction<Data, Long> in, AggregateFunction<GroupData, Long> out) {
        this.in = in;
        this.out = out;
    }
